...
<body bgcolor="white"><p>
	...
	<tr><td colspan="3">
	 ...
	 <tr> 
	 <td colspan="1" align="left" valign="top"> <object type="image/jpeg" data="checkid.do?action=displayfile&amp;subid=<%= listSubmitID %>&amp;ctype=jpg&amp;file=plot.jpg"  width="450" height="450"></object> </td> 

	 </tr>
	 </table> 
	 <table border="0" cellpadding="12" cellspacing="0" width="100%"> 
	 <tr> 
	 <td colspan="1" align="left" valign="top"> <object type="text/plain"  data="checkid.do?action=displayfile&amp;subid=<%= listSubmitID %>&amp;ctype=txt&amp;file=coefficients.txt" width="700" height="150"></object> </td> 
